  ...
  function() {
    ...
    function leftWindowAnimation(animLength, bgColor) {
      anime({
        ...
        //translateX: [{ value: "-17%", duration: 200 }],
    ...
    var portfolio = [
      {
        name: "freeCodeCamp",
        description:
          "<p>All kinds of simple web apps. Some are games, others are utilities.</p><p>Made with CSS, JS and <i>love.</i></p>",
        links: [
          {
            link: "/freecode.html"
          },
      ...
      },
      {
        name: "mikireader",
        description:
          "<p>A simple, server-less .epub reader in your browser</p>",
        links: [
          {
      ...
      },
      {
        name: "Gritour",
        description:
          "<p>I made the website for Gritour: a Freelancer Tour Guide from Buenos Aires, Argentina. <p>I also designed her logo</p>",
        links: [
          {
      ...
      },
      {
        name: "BOTW Check",
        description:
          "<p>The latest Zelda game is going to be available for PC (via emulation)!</p><p>This website will notify you when emulation reaches an stable status.</p>SUCCESS! More than 2.000 people suscribed in less than two weeks.",
        links: [
          {
    ...
    portfolio.forEach(el => {
      ...
      portfolioInner.innerHTML +=
        '<li><div class="portfolio-project"><div class="project-main">' +
        el.name +
    ...
    var song = new Howl({
      src: [
        "https://crossorig.in/http://alicemp3.su/mp3/bodca370dmc96c3u8452fbbn47dy3v8b4c44b7dy6b7va84u14en692vb4cm4599.mp3"
      ],
      volume: 0.5,
      loop: true,
      preload: false
